        ...
        try {
            ...
            switch ($job['step']) {
                case 'init':
                    ...
                    break;
                case 'db_init':
                    $job['db_file'] = FgBackup_Backup::get_backup_dir() . "fg-db-" . date('Y-m-d-H-i-s') . ".sql";
                ...
                case 'files_zip':
                    ...
                    $files = array_slice(FgBackup_Backup::get_all_files(), $job['file_index'], 50); // in Chunks von 50 Dateien
